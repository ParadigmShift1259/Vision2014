...
public class HoughLines {
    ...
    public static void Smain(String[] args) {
        ...
        final FrameGrabber frame = new VideoInputFrameGrabber(0);
        ...
        try {
            ...
            Logger.getLogger(HoughLines.class.getName()).log(Level.SEVERE, null, ex);
        }
        IplImage dst;
        IplImage colorDst;
//        IplImage gray;
        //CvMemStorage storage = cvCreateMemStorage(1);
...
//        gray = cvCreateImage(cvGetSize(src), src.depth(), 3);
